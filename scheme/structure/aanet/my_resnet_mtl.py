...
from .conv_mtl import Conv2dMtl
from scheme.replay.podnet import pooling
...
class CifarResNet(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        printlog("Downsampling type {}".format(downsampling))
